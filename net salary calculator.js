    ...
    function kratax(basicSalary, benefits){
        ...
        function benefitsfunction(basicSalary, benefits = 0){
            let  nhifDeduction = 0
             ...
             if (basicSalary > 0 <= 5999){
               nhifDeduction  = 150
               
             }else if (basicSalary >= 6000  <= 7999){
               nhifDeduction =300
         
             }else if(basicSalary >= 8000 <= 11999){
               nhifDeduction =400
         
             }else if(basicSalary >= 12000  <= 14999){
               nhifDeduction =500
             }
             else if(basicSalary >= 15000  <= 19999){
               nhifDeduction =600
         
             }
             else if(basicSalary >= 20000  <= 24999){
               nhifDeduction =750
         
             }
             else if(basicSalary >= 25000  <= 29999){
               nhifDeduction =850
         
             }
             else if(basicSalary >= 30000  <= 34999){
               nhifDeduction =900
         
             }
             else if(basicSalary >= 35000 <= 39999){
               nhifDeduction =950
             ...
             else if(basicSalary >= 50000  <= 59999){
               nhifDeduction =1200
         
             }
             else if(basicSalary >= 60000  <= 69999){
               nhifDeduction =1300
         
             }
             else if(basicSalary >= 70000  <= 79999){
               nhifDeduction =1400
         
             }
             else if(basicSalary >= 80000 <= 89999){
               nhifDeduction =1500
         
             }
             else if(basicSalary >= 90000 <= 99999){
               nhifDeduction =1600
        ...
        }else if (taxableIncome >= 24001<= 32333){
            rated = (taxableIncome - 24000) * 0.25;
            grossTax = 2400 + rated
        }else if (taxableIncome >= 32334 <= 500000){
            rated = (taxableIncome - 32333) * 0.30;
            grossTax = 2400 + 2083.25 + rated
        }else if (taxableIncome >= 500001  <= 800000){
